...
\begin{enumerate}
    ...
    \item \textbf{Visualización de resultados}: Al trabajar con una simulación físca en un entorno 3D, la visualización en gráficos de las predicciones de los modelos ha resultado notablemente útil. En las figuras siguientes 3.6, 3,7, 3,8 pueden apreciarse los gráficos más destacados que más han contribuido al desarollo.        
        \begin{figure}[H]
            \centering
