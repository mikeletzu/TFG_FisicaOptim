...
\begin{itemize}
    ...
    \item \textbf{SDF}: El Signed Distance Field es una magnitud que representará la distancia de cada vértice al objeto colisionador, llegando a ser 0 si toca la superfície, y un valor negativo si alcanza a traspasar. 
