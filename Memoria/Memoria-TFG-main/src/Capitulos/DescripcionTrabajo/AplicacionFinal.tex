...
Una vez se tenga la respuesta del servidor empieza de nuevo la corrutina, se ordena de mayor a menor score las predicciones mediante bubble sort para escribirlas en el panel correspondiente y se ejecuta la animación de respuesta del npc.
...
\begin{table}[H]
    \begin{center}
        \begin{tabular}{| c | c |}
            ...
            Correr   & Correr                \\ \hline
        \end{tabular}
        \caption{Reacción del npc al gesto predicho del jugador}
