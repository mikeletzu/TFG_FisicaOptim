\section{Análisis de los resultados visuales}
\label{sec:Visual}
...
\begin{itemize}
  ...
  \item Por otra parte, los únicos modelos capaces de mantener la estructura de la tela son el RNN y el PCA, ambos con unfolding. El segundo consigue recuperar al completo la estructura de reposo tras interactuar con el colisionador, aunque en ambos casos esta recuperación puede tener un efecto visual interpolado. 
