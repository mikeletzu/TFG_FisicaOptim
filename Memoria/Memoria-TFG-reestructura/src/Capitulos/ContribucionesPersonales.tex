...
- EVA CNN PCA
- MIK SNUG HOOD
- EVA PAU investigación sobre otras técnicas (obi cloth, accel gpu, uniti cosas...) y otros repos PAU sentis
...
como se ha mencionado, la incorporación de Sentis al flujo de trabajo 
...
A la par que sus compañeras avanzaban con el desarrollo de la herramienta de grabación de las simulaciones, Mikele compenzó 
Se creó una base de entrenamiento con Pytorch
- MIK era una herramienta nueva así q investigación de recursos para aprender
- MIK setup del environment de conda loooooooooooooooooooool
- MIK carga del dataset
