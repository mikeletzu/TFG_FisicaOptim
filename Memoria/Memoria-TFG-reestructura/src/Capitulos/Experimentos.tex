...
\begin{table}[H]
    \begin{center}
        ...
        \hline \textbf{Prueba} & \textbf{T entrenamiento} & \textbf{T inferencia} & \textbf{Error medio por vertice} & \textbf{FPS} \\ \hline
            MLP & 8h(gpu) & 2.25952ms & 0.001929 & 423 \\ \hline
            RNN & 18h(gpu) & 2.58243ms & 0.002 & 429 \\ \hline
        \end{tabular}
    \end{center}
...
\begin{table}[H]
    \begin{center}
        ...
        \hline \textbf{Rolling steps} & \textbf{T entrenamiento} & \textbf{T inferencia} & \textbf{Error medio por vertice} & \textbf{FPS} \\ \hline
            1 & 1.5h(gpu) & 2.17ms & 0.0008 & 427 \\ \hline
            24 & 18h(gpu) & 2.17ms & 0.0013 & 429 \\ \hline
        \end{tabular}
    \end{center}
    \caption{Resultados de los entrenamientos en base al rendimiento (Unrrolling).}
...
\begin{table}[H]
    \begin{center}
        ...
        \end{tabular}
    \end{center}
    \caption{Resultados de los entrenamientos en base a la percepción (Unrrolling).}
...
\begin{table}[H]
    \begin{center}
        ...
        \hline \textbf{Prueba} & \textbf{T entrenamiento} & \textbf{T inferencia} & \textbf{Error medio por vértice} & \textbf{FPS} \\ \hline
            Pos & 18h(gpu) & 2.25952ms & 0.0013m & 413 \\ \hline
            Pos + Vel & 18h(gpu) & 0.0ms & 0.0009m & 411 \\ \hline
        \end{tabular}
    \end{center}
...
\begin{table}[H]
    \begin{center}
        \begin{tabular}{ | m{2.2cm} |  m{2.8cm} | m{2.8cm} | m{2.6cm} | m{1.2cm} |}
        \hline \textbf{Prueba} & \textbf{T entrenamiento} & \textbf{T inferencia} & \textbf{Error medio por vértice} & \textbf{FPS} \\ \hline
            RNN & 18h(gpu) & 2.17ms & 0.0013 & 444 \\ \hline
