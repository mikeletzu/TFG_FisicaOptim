...
\begin{table}[H]
    \begin{center}
        ...
        \hline \textbf{Rolling steps} & \textbf{T entrenamiento} & \textbf{T inferencia} & \textbf{Error medio por vertice} & \textbf{FPS} \\ \hline
            1 & 1.5h(gpu) & 0.0ms & 0.0008 & 0 \\ \hline
            24 & 18h(gpu) & 2.58243ms & 0.002 & 0 \\ \hline
        \end{tabular}
    \end{center}
    \caption{Resultados de los entrenamientos en base al rendimiento.}
...
\begin{table}[H]
    \begin{center}
        ...
        \hline \textbf{Rolling steps} & \textbf{Reactividad} & \textbf{Conservación} & \textbf{Estabilidad} & \textbf{Credibilidad} \\ \hline
            1 & 0/3 & 0/3 & 0/3 & 0/3 \\ \hline
            24 & 0/3 & 0/3 & 0/3 & 0/3 \\ \hline
        \end{tabular}
    \end{center}
    \caption{Resultados de los entrenamientos en base a la percepción.}
