...
\Function{RunRollout}{$ batch\_seq, batch\_future$}
    ...
    \BlankLine
    \State $\textbf{\textit{Comparación:}}$
        \State $real\_pos \gets batch\_future[:, k, :, 0:3]$ \Comment{Posición real}
        \State $real\_delta\_norm \gets \text{NormDelta}(real\_pos - prev\_pred\_pos)$
    ...
    \BlankLine
    \State $total\_loss \gets total\_loss + loss\_pos$
    }
